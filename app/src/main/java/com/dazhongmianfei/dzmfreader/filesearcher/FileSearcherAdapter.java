package com.dazhongmianfei.dzmfreader.filesearcher;
...
import com.dazhongmianfei.dzmfreader.filesearcher.searchengine.FileItem;
import com.dazhongmianfei.dzmfreader.filesearcher.searchengine.SearchEngine;
...
public class FileSearcherAdapter extends RecyclerView.Adapter<FileSearcherAdapter.FileSearcherVH> {
    ...
    public FileSearcherAdapter(Context context,@NonNull SearchEngine searchEngine){
        colorUnchecked = context.getResources().getColor(com.dazhongmianfei.dzmfreader.R.color.fileSearcherWhite);
        colorChecked = context.getResources().getColor(com.dazhongmianfei.dzmfreader.R.color.fileSearcherCheckedBackground);
        this.searchEngine = searchEngine;
    }

    @Override
    public FileSearcherVH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FileSearcherVH(LayoutInflater.from(parent.getContext()).inflate(com.dazhongmianfei.dzmfreader.R.layout.file_searcher_item,parent,false));
    }
    ...
    class FileSearcherVH extends RecyclerView.ViewHolder{
        ...
        public FileSearcherVH(final View itemView) {
            super(itemView);
            title = itemView.findViewById(com.dazhongmianfei.dzmfreader.R.id.file_searcher_item_text_title);
            detail = itemView.findViewById(com.dazhongmianfei.dzmfreader.R.id.file_searcher_item_text_detail);
            path = itemView.findViewById(com.dazhongmianfei.dzmfreader.R.id.file_searcher_item_text_path);
            checkBox = itemView.findViewById(com.dazhongmianfei.dzmfreader.R.id.file_searcher_item_check_box);

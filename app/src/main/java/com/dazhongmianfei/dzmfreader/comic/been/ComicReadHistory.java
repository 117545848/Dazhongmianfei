...
public class ComicReadHistory {
    ...
    public static class ReadHistoryComic  extends BaseAd {
        ...
        public String vertical_cover;//": "http://dazhongmianfei.oss-cn-beijing.aliyuncs.com/comic/cover/ccwmiw4peep35.jpg?x-oss-process=image%2Fresize%2Cw_300%2Ch_400%2Cm_lfit",   // 竖图
    ...
    public static void addReadHistory(boolean FORM_READHISTORY, final Activity activity, final String comic_id, String chapterid) {
        ...
        HttpUtils.getInstance(activity).sendRequestRequestParams3(ComicConfig.COMIC_read_log_add, json, false, new HttpUtils.ResponseListener() {
                    @Override

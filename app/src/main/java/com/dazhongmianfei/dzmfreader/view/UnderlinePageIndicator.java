...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        // if (background != null) {
        setBackgroundResource(R.styleable.UnderlinePageIndicator_android_background);
        //  }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float left = paddingLeft + pageWidth / 4f + pageWidth * (mCurrentPage + mPositionOffset);
        final float right = left + pageWidth / 2f;

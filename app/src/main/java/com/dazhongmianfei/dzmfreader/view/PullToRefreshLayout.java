...
//    private View refreshStateImageView;
    ...
    private boolean mStartedAnim = false;
...
//        refreshStateImageView = refreshView.findViewById(R.id.state_iv);
        ...
        loadStateTextView = loadmoreView.findViewById(R.id.loadstate_tv);
        ...
        if (mPullListener != null) {
           ...
           /* if (pullDownY > 50) {
                if (!mStartedAnim) {
                    ...
                    AnimationDrawable anim = (AnimationDrawable) pullView.getDrawable();
                    anim.start();
                    mStartedAnim = true;
                }
            }*/
            mPullListener.onPulling(pullDownY);
        }
    }

...
import static com.dazhongmianfei.dzmfreader.activity.BaseActivity.getStatusBarHeight;
...
public class StatusBarUtil {
    ...
    public static void transparencyBar2(Activity activity, int bgcolor, boolean textcolor) {
        Window window = activity.getWindow();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            statusBarView.setBackgroundColor(ContextCompat.getColor(activity, bgcolor));
...
//        }
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        try {
            if (Build.VERSION.SDK_INT < 23) {
                StatusBarCompat.setStatusBarColor(activity, Color.BLACK, false);
            } else {
    ...
    private static void setOtherStatusTextColor(Activity activity, boolean useDart) {
        ...
        activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding
                (0, 0, 0, getStatusBarHeight(activity));
    }
}

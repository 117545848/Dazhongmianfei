...
public class ReaderParams {
    ...
    public ReaderParams(Context context) {
        ...
        paramList.add("packageName=com.dazhongmianfei.dzmfreader");
        ...
        nameValuePair.put("packageName", "com.dazhongmianfei.dzmfreader");
    ...
    public String generateParamsJson() {
        ...
        Utils.printLog(TAG, "generateParamsJson:" + json);
        return json;
    }

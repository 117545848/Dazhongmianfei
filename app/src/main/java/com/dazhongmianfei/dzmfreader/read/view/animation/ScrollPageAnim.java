...
public class ScrollPageAnim extends PageAnimation {
    ...
    public ScrollPageAnim(Bitmap mCurrentBitmap, Bitmap mNextBitmap,int w, int h, int marginWidth, int marginHeight,
                          View view, OnPageChangeListener listener) {
        super(mCurrentBitmap,mNextBitmap,w, h, marginWidth, marginHeight, view, listener);
        // 创建两个BitmapView
        initWidget();
    }
...
/*        //设置背景透明
    ...
    @Override
    public void startAnimation(Scroller scroller, OnAnimationStopped stopped) {

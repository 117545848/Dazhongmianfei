...
import com.dazhongmianfei.dzmfreader.read.util.CommonUtil;
...
//        background = BitmapFactory.decodeResource(getResources(),R.mipmap.bookshelf_layer_center);
...
//                mDeleteButton = (ImageButton) mGridItemView.findViewById(R.id.shelfitem_delete);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // Utils.printLog("mDagPosition is", "" + mDragPosition);
    ...
    private void animateReorder(final int oldPosition, final int newPosition) {
        ...
        if (isForward) {
            for (int pos = oldPosition; pos < newPosition; pos++) {
                ...
                // Utils.printLog("oldPosition",""+ pos);
...
//    }
    ...
    public void onClick(View v) {
        // Utils.printLog("deleteImageButton","ok");

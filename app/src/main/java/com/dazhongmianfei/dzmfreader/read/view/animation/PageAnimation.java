package com.dazhongmianfei.dzmfreader.read.view.animation;
...
public abstract class PageAnimation  extends AnimationProvider{
    ...
    //移动方向
    protected AnimationProvider.Direction mDirection = AnimationProvider.Direction.none;
    ...
    public PageAnimation(Bitmap mCurrentBitmap, Bitmap mNextBitmap,int w, int h, View view, OnPageChangeListener listener){
        this(mCurrentBitmap,mNextBitmap,w, h, 0, 0, view,listener);
    }



    public PageAnimation(Bitmap mCurrentBitmap, Bitmap mNextBitmap,int w, int h, int marginWidth, int marginHeight, View view, OnPageChangeListener listener){
        super(mCurrentBitmap, mNextBitmap, w, h);
        mScreenWidth = w;
        mScreenHeight = h;
